...
namespace PREDJL.Mantenimiento
{
    public partial class Puestos : System.Web.UI.Page
    {
        ...
        protected void GV_Puestos_InitNewRow(object sender, DevExpress.Web.Data.ASPxDataInitNewRowEventArgs e)
        {
            GV_Puestos.SettingsText.PopupEditFormCaption = "Nuevo ingreso de puesto";
        }

        protected void GV_Puestos_StartRowEditing(object sender, DevExpress.Web.Data.ASPxStartRowEditingEventArgs e)
        {
            GV_Puestos.SettingsText.PopupEditFormCaption = "Editar ingreso de puesto";
        }

        protected void GV_Puestos_RowUpdated(object sender, DevExpress.Web.Data.ASPxDataUpdatedEventArgs e)
        {
        ...
        protected void GV_Puestos_RowInserted(object sender, DevExpress.Web.Data.ASPxDataInsertedEventArgs e)
        {
            if (e.Exception == null)
            {
