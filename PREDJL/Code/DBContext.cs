...
namespace PREDJL.Model
{
    ...
    public static class DataProvider
    {
        ...
        public static void DeleteIssues(List<int> ids)
        {
            List<Issue> issues = GetIssues();
        ...
        internal static int GetNextIssueId()
        {
            IEnumerable<int> issuesIds = GetIssues().Select(i => i.Id);
    ...
    public class AppointmentDataSourceHelper
    {
        ...
        public static object InsertMethodHandler(SchedulerAppointment newAppointment)
        {
            ...
            int maxId = list.Count == 0 ? 0 : list.Max(i => i.Id);
    ...
    public static class ResourceDataSourceHelper
    {
        ...
        public static List<SchedulerResource> GetItems(List<int> ids)
        {
            if (ids == null)
                return items;
